            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-24 lg:pt-24 lg:pb-32 relative">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="relative">
                        <div className="absolute -inset-4 bg-linear-to-r from-green-500 to-blue-500 rounded-[2.5rem] blur-lg opacity-20 animate-pulse-slow"></div>
                        <ChatInterface />
                        
                        {/* Floating Tooltip */}
                        <div className="absolute top-20 -right-4 lg:-right-12 bg-white dark:bg-gray-800 rounded-xl shadow-xl p-3 items-center gap-3 animate-float hidden lg:flex border border-gray-100 dark:border-gray-700">
